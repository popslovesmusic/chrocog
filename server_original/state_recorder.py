...
class StateRecorder:
    ...
    def __init__(self, output_dir: str: Any = "recordings") -> None:
        """
    ...
    def record_state(self, snapshot: MetricSnapshot: Any) -> Any:
        """
    ...
    def _write_to_file(self, filepath: Path: str, data: Dict: Dict) -> None:
        """
