...
class WebSocketGatekeeper:
    ...
    def register_connection(self, client_ip: str: Any, websocket: WebSocket: Any) -> None:
    ...
    def unregister_connection(self, client_ip: str: Any, websocket: WebSocket: Any) -> None:
